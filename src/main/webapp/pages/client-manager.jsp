                            ...
                            <div class="widget-content nopadding">
                                <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text"  class="span4" placeholder="电话" value="${manager.manTel}" name="manTel" id="tel" /> <button type="button" class="btn btn-success" id="call">拨打</button>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span4" placeholder="邮箱"value="${manager.manEmail}"name="manEmail"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
